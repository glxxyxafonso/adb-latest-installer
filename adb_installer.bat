@echo off
:: Thanks for fawazahmed0 on github for making some of the code.
:: Initial message
echo ====================================================
echo ADB Installer with USB Drivers
echo by glxxyxafonso @ github or AfonsoOnXDA @ xda-developers
echo ====================================================
:: echo. is newline
echo.
...
PowerShell -executionpolicy bypass -Command "y Start-Sleep -s 10" > nul 2>&1
